...
router.delete('/delete', verifyJWT, adminMiddleware,validate(deleteCategoryValidation),deleteCategory);
router.put('/update', verifyJWT, adminMiddleware,validate(updateCategoryValidation),updateCategory);
